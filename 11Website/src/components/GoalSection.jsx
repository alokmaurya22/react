        ...
        <section className="py-20 bg-[#131726] text-white">
            <div className="container mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-gradient-to-r from-purple-500 to-indigo-600 p-8 rounded-xl transition-transform duration-300 transform hover:scale-105">
                    ...
                    <div className="bg-gradient-to-r from-green-500 to-teal-600 p-8 rounded-xl transition-transform duration-300 transform hover:scale-105">
                        <div className="flex justify-center mb-4">
                            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
                    ...
                    <div className="bg-gradient-to-r from-red-500 to-pink-600 p-8 rounded-xl transition-transform duration-300 transform hover:scale-105">
                        <div className="flex justify-center mb-4">
                            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
